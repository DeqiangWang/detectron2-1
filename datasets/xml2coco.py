...
# voc2007xmls = 'anns'
voc2019xmls = 'VOCdevkit/VOC2019/Annotations'
# test_txt = 'voc2007/test.txt'
test_txt = 'VOCdevkit/VOC2019/ImageSets/Main/trainval.txt'
xml_names = txt2list(test_txt)
xmls = []
bboxes = []
ann_js = {}
for ind, xml_name in enumerate(xml_names):
    xmls.append(os.path.join(voc2019xmls, xml_name + '.xml'))
json_name = 'annotations/instances_voc2019trainval.json'
images = []
